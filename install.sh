...
LOCAL_OLLAMA_URL="${LOCAL_OLLAMA_URL:-http://192.168.0.5:11434}"
LOCAL_WHISPER_URL="${LOCAL_WHISPER_URL:-http://192.168.0.5:9000}"
LOCAL_IMAGE_URL="${LOCAL_IMAGE_URL:-http://localhost:8000}"
LLM_MODEL="${LOCAL_LLM_MODEL:-llama3.2:3b}"
EMBEDDING_MODEL="${EMBEDDING_MODEL:-nomic-embed-text}"
CMS_API_URL="${CMS_API_URL:-http://studio:3001}"
...
echo "   🔗 CMS API interna: $CMS_API_URL"
...
update_env "CMS_API_URL" "$CMS_API_URL"
